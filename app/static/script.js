...
function saveIncome() {
    ...
    if (!isNaN(income)) {
        ...
        listItem.textContent = 'Income: $' + income.toFixed(2);
        listItem.dataset.amount = income; // Store amount as a data attribute
...
function updatePieChart() {
    ...
    window.pieChart = new Chart(ctx, {
        ...
        options: {
            legend: {
                labels: {
                    fontColor: 'rgb(255, 255, 255)' //an attempt to made the labels for the pie chart text white to see easier but does not work, need to fix this.
                }
            }
        }
    });
